...
for ii = 1:n
    % Compute i-th column of distance matrix---i.e. i-th entity
    ...
    indi(1, (ii-1)*k+1:ii*k) = ii; %ii-th entity
    indj(1, (ii-1)*k+1:ii*k) = O(1:k);% k-th nearest neighbour 
    inds(1, (ii-1)*k+1:ii*k) = s(1:k);% k-th indices
end
